...
import { BookingTypeFormData } from "../../facilities/[id]/_forms/booking-type-validation";
import { BookingFormDataWithNames, FacilityFormDataWithNames, ValueLabelPair } from "../../../lib/app-data/app-types";
...
import BookingSlots from "../../_components/custom-form-fields/booking-slots";
...
const BookingUpsertForm = (props: BookingUpsertFormProps) => {
  ...
  // -------------- BACKEND QUERIES -------------- //
  /**
   * Fetch occupant options for the form select field
   */
  ...
  /**
   * Fetch facility options for the form select field
   */
  ...
  const bookingTypes = useQuery(
    api.bookingTypes.getBookingTypesForFacility,
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <Select
                    ...
                    disabled={!occupantOptions || occupantOptions.length === 0}
                  >
                    <FormControl>
                      <SelectTrigger>
                        <SelectValue
                ...
                <FormItem>
                  ...
                  <Select
                    onValueChange={(value) => {
                      ...
                      // Reset bookingTypeId when facility changes
                      form.setValue("bookingTypeId", "");
                    }}
                    value={field.value}
                    disabled={!facilityOptions || facilityOptions.length === 0}
                  >
                    <FormControl>
                      <SelectTrigger>
